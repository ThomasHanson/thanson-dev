    ...
    >
      <section className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          ...
          <ItemLink itemName="Lenovo - ThinkPad T470s (Type 20HG) - Intel Core i5 (14 inch, 8GB RAM, 128GB SSD) - Black" href="https://www.lenovo.com/us/en/p/laptops/thinkpad/thinkpadt/thinkpad-t470s/22tp2tt470s" />
          ...
          <ItemLink itemName="HyperX QuadCast S - RGB USB Condenser Microphone" href="https://www.amazon.com/HyperX-QuadCast-Condenser-Microphone-Anti-Vibration/dp/B08G8WH435" />
        </div>
      </section>
    </Page>
  );
